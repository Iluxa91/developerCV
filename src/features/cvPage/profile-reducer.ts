...
let initialState = {
    ...
    quizResults: {
        'skillID1': [{title: 'DOM', rating: 4.5}, {title: 'HTML', rating: 4.2},
            {title: 'CSS',rating: 4.0}, {title: 'JavaScript', rating: 3.0}, {title: 'ReactComponents', rating: 3.5}],
        'skillID2': [{title: 'DOM', rating: 4.5}, {title: 'HTML', rating: 4.2},
            {title: 'CSS',rating: 4.0}, {title: 'JavaScript', rating: 3.0}, {title: 'ReactComponents', rating: 3.5}]
    },
    codingChallengeResults: {
        'skillID1': [{title: 'Sorting algorithm', rating: 4.5}, {title: 'Strings and arrays',rating: 4.2
        }, {title: 'Complexity', rating: 4.0}],
        'skillID2': [{title: 'Sorting algorithm', rating: 4.5}, {title: 'Strings and arrays',rating: 4.2
        }, {title: 'Complexity', rating: 4.0}]
    },
    workExperiences: [
        {title:'Senior Frontend Developer',institutionTitle:'Sberbank', description: 'Hello, I am a person who has a strong passion for programming. I have experience in creating SPA with React/Redux/TypeScript. Now I am improving my skills in this direction and expanding them with new technologies. I\'m planing to study Node.js, because my next focus is to become a FullStack Developer. I spend my leisure time improving my English and studying new technologies. Open for your suggestions.', dates:'2 years 2 month | June 2019 - October 2021',
        ...
        {title:'Middle Frontend Developer',institutionTitle:'Sberbank', description: 'Hello, I am a person who has a strong passion for programming. I have experience in creating SPA with React/Redux/TypeScript. Now I am improving my skills in this direction and expanding them with new technologies. I\'m planing to study Node.js, because my next focus is to become a FullStack Developer. I spend my leisure time improving my English and studying new technologies. Open for your suggestions.',dates:'2 years 2 month | June 2019 - October 2021',
            languages: [{icon:jsImg, title:'JavaScript'}, {icon:javaspringImg, title:'JavaSping'}],
            technologies: [{icon:reactImg, title:'React'}, {icon:nodeImg, title:'Node.js'}]
        }
    ],
    education: [
        {title:'Computer Science', institutionTitle: 'Boston Academy', dates: '2 years 2 month | June 2019 - October 2021'},
        {title:'Computer Science', institutionTitle: 'Cleveland College', dates: '1 years 2 month | July 2017 - June 2019'}
    ]
}
...
export type InitialStateType = {
    ...
    vattedSkills: VattedSkillsType[]
    quizResults: ResultsType
    codingChallengeResults: ResultsType
...
export type ResultsType = {
    [vattedSkillID:string]: {title:string, rating:number}[]
}
export type StacksType = {
    icon: { backgroundImage: string }
    title: string
}
export type VattedSkillsType = {
    id:string,
    title: string,
    rating: number
    icon: { backgroundImage: string }
